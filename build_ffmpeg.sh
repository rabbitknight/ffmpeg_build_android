...
NDK_PATH=$2
HOST_PLATFORM=$3
ENABLED_DECODERS=(aac aac_latm flv h264 mp3* vp6f flac hevc vp8 vp9)
...
./configure \
    ...
    --cxx="${TOOLCHAIN_PREFIX}/armv7a-linux-androideabi16-clang++" \
...
./configure \
    ...
    --cxx="${TOOLCHAIN_PREFIX}/aarch64-linux-android21-clang++" \
...
./configure \
    ...
    --cxx="${TOOLCHAIN_PREFIX}/i686-linux-android16-clang++" \
...
./configure \
    ...
    --cc="${TOOLCHAIN_PREFIX}/x86_64-linux-android21-clang" \
    --cxx="${TOOLCHAIN_PREFIX}/x86_64-linux-android21-clang++" \
